        ...
        vue(),
        {
            ...
            configureServer: function (server) {
                ...
                var readAllDesigns = function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_b) {
                        switch (_b.label) {
                            ...
                            case 1:
                                _b.sent();
                                return [4 /*yield*/, fs.readdir(productDesignDir)];
                            case 2:
                                files = _b.sent();
                                designs = {};
                                _i = 0, files_1 = files;
                ...
                var productDesignHandler = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
                    var url, data, putPrefix1, putPrefix2, isPut, id, bodyText, payload, version, versionFile, files, _i, files_2, file, filePath, data_1, data;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                url = req.url || '';
                                if (!(req.method === 'GET' && (url === '/api/product-designs' || url === '/ai-short-drama-creator/api/product-designs'))) return [3 /*break*/, 2];
                                return [4 /*yield*/, readAllDesigns()];
                            case 1:
                                data = _a.sent();
                                res.statusCode = 200;
                            ...
                            case 3:
                                ...
                                versionFile = path.join(productDesignDir, "".concat(version, ".json"));
                                return [4 /*yield*/, fs.readdir(productDesignDir)];
                            case 4:
                                files = _a.sent();
                                _i = 0, files_2 = files;
                            ...
                            case 5:
                                ...
                                file = files_2[_i];
                                if (!file.endsWith('.json')) return [3 /*break*/, 8];
                                filePath = path.join(productDesignDir, file);
                                return [4 /*yield*/, readJsonFile(filePath)];
                            case 6:
                                data_1 = _a.sent();
                                if (!data_1[id]) return [3 /*break*/, 8];
                                delete data_1[id];
                                return [4 /*yield*/, writeJsonFile(filePath, data_1)];
                            case 7:
                                _a.sent();
                                _a.label = 8;
                            case 8:
                                _i++;
                                return [3 /*break*/, 5];
                            case 9: return [4 /*yield*/, readJsonFile(versionFile)];
                            case 10:
                                data = _a.sent();
                                data[id] = payload;
                                return [4 /*yield*/, writeJsonFile(versionFile, data)];
                            case 11:
                                _a.sent();
                                res.statusCode = 200;
                                res.setHeader('Content-Type', 'application/json');
